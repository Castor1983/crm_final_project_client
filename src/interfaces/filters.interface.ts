...
export const getInitialFilters = (searchParams: URLSearchParams): Filters => ({
    ...
    course_format: (searchParams.get("course_format") as CourseFormatEnum) || CourseFormatEnum.EMPTY,
    course_type: (searchParams.get("course_type") as CourseTypeEnum) || CourseTypeEnum.EMPTY,
